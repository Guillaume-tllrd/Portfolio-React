...
const Acceuil = () => {
    return (
        <>
        <div className='md:flex mx-auto dark:bg-black1 pt-10 lg:pt-0'>
            ...
            <div className=' lg:flex lg:flex-col lg:justify-center '>
                ...
                <h3 className='font-manrope ml-8 w-[380px] text-4xl text-center  py-2 xl:mx-auto bg-no-repeat bg-bottom dark:text-white' style={{ backgroundImage: "url('./souligne_jaune.png')", backgroundPosition: '2200% 105%'}}>Développeur fullstack</h3>
                <IconeMedia />
